        ...
        while (1)
        {
            ...
            if (strcmp(Pkt->GetHead()->Route, "POST") == 0)
            {
                ...
                else if (strcmp(Pkt->GetHead()->Route, "DELETE_POST") == 0)
                {
                    ...
                    oss << "SELECT postID FROM listings WHERE "
                        << "(id = " << (int)Pkt->GetBody()->User << ") "
                        << "AND "
                        << "(title = '" << list.Title << "') "
                        << "AND "
                        ...
                        << "AND "
                        << "(estimated_worth = '" << list.EstimatedWorth << "') "
                        << "AND "
                    ...
                    oss << "DELETE FROM listings WHERE "
                        << "postID = '" << postID << "';";
