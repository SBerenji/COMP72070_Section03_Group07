...
Packet* ListingRoutes::handleRequest(Packet& packet, SOCKET clientSocket, std::string action) {
	...
	if (action == "create") {
		resultPacket = handleCreateListing(listing);
	}
	else if (action == "register") {
		resultPacket = handleGetListing(listing);
	}
	else if (action == "update") {
		resultPacket = handleUpdateListing(listing);
	}
	else if (action == "delete") {
		resultPacket = handleDeleteListing(listing);
	}
	else {
